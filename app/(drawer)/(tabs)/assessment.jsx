        ...
        <View className="gap-4">
          <View className="rounded-[24px] border border-[#e8dfda] bg-card px-4 py-4">
            ...
            <View className="gap-2">
              {assessmentFeatures.map((feature) => (<View key={feature} className="flex-row items-center gap-3 rounded-[16px] bg-[#fff8f5] px-3 py-3">
          ...
          {!testUnlocked ? (<View className="rounded-[24px] border border-[#e8dfda] bg-card px-4 py-4">
