  ...
  return (
    <Screen>
      ...
      <View className="gap-3">
        {filtered.map((item) => (
          <View key={item.title} className="gap-[14px] rounded-[22px] border border-line bg-card p-4" style={{ opacity: item.locked ? 0.82 : 1 }}>
            ...
            <AnimatedPressable
              ...
              className="rounded-[14px] py-[11px]"
              style={{ backgroundColor: item.locked && !masterClassUnlocked ? `${palette.primary}12` : '#fff8f1' }}
            >
