...
export default function AssessmentScreen() {
    ...
    <Screen>
      <View className="overflow-hidden rounded-[34px] bg-[#fcf8f5] px-4 pb-8 pt-3">
        ...
        <View className="mb-7 flex-row items-center gap-3">
          ...
          <Text className="text-[22px] font-extrabold text-ink">Career Assessment</Text>
        </View>
        ...
        <View className="items-center pb-4">
          ...
          <Text className="text-center text-[32px] font-black text-ink">Full Psychometric Test</Text>
        ...
        <View className="gap-4">
          <View className="rounded-[24px] border border-[#e8dfda] bg-card px-4 py-4">
            <Text className="mb-3 text-[17px] font-extrabold text-brand">Test Features</Text>
            <View className="gap-2">
              {assessmentFeatures.map((feature) => (
                <View key={feature} className="flex-row items-center gap-3 rounded-[16px] bg-[#fff8f5] px-3 py-3">
                  ...
                  <Text className="flex-1 text-[14px] font-semibold text-ink">{feature}</Text>
                </View>
              ))}
            </View>
          </View>
  ...
  className="mt-3 w-full self-center rounded-full bg-brand px-5 py-2.5 items-center justify-center"
>
  <Text className="text-[13px] font-extrabold text-white text-center">
    View Plans
          ...
          <AnimatedPressable
            onPress={() => (testUnlocked ? router.push('/(drawer)/psychometric-test') : router.push('/(drawer)/subscription'))}
          ...
          <View className="rounded-[18px] bg-[#fff7f3] px-4 py-4">
            <Text className="text-[12px] font-bold uppercase tracking-[0.8px] text-brand">Status</Text>
            <Text className="mt-1 text-[15px] font-extrabold text-ink">
